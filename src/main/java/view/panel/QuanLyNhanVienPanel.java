	...
	public QuanLyNhanVienPanel() {
		...
		btnThem.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ThemNhanVienDialog themDichVuDialog = new ThemNhanVienDialog(QuanLyNhanVienPanel.this);
		...
		btnSua.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					SuaNhanVienDialog suaDialog = new SuaNhanVienDialog(QuanLyNhanVienPanel.this, nhanVien);
					suaDialog.setVisible(true);
				} else {
					JOptionPane.showMessageDialog(QuanLyNhanVienPanel.this, "Vui lòng chọn nhân viên để sửa!", "Lỗi",
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				...
				frame.setContentPane(new QuanLyNhanVienPanel());
				frame.pack();
